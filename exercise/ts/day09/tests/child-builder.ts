...
export class ChildBuilder {
    ...
    public constructor() {
        ...
        this.behavior = 'nice';
        this.giftRequest = new GiftRequestBuilder().withFeasibleGiftRequest().build();
    }
    ...
    withInfeasibleGiftRequest(): this {
        this.giftRequest = new GiftRequestBuilder().withInfeasibleGiftRequest().build();
        return this;
    }

    public build() {
        return new Child(this.firstName, this.lastName, this.age, this.behavior, this.giftRequest);
    }
}
